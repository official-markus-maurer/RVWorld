...
namespace StorageList
{
    ...
    {
        public delegate int SortOn<T1, T2>(T1 fileGroup1, T2 fileGroup2);
        public static int ListSearch2<T1, T2>(List<T1> list, T2 lName, SortOn<T2, T1> CompareName, out int index)
        {
            int intBottom = 0;
